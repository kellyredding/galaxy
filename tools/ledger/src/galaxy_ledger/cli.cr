...
module GalaxyLedger
  class CLI
    ...
    private def self.prune_summary
      ...
      puts ""
      puts "Preserved per session: session record, daily usages, artifacts"
      puts ""
    ...
    private def self.prune_apply(duration_label : String, days : Int32)
      ...
      puts ""
      puts "Session records, daily usages, and artifacts preserved."
    end
    ...
    private def self.show_prune_help
      ...
      DESCRIPTION:
        ...
        usage metrics, and artifacts are always preserved.
