...
module GalaxyLedger
  ...
  module Extraction
    ...
    class Result
      ...
      # Session title generated by the extraction (only for assistant response extraction)
    ...
    private def self.parse_extraction_result(
      ...
      begin
        ...
        # Parse session title if included
        session_title : String? = nil
        if include_summary
          session_title = json["session_title"]?.try(&.as_s?)
        end
        ...
        Result.new(extractions: extractions, summary: summary, session_title: session_title)
      rescue ex
